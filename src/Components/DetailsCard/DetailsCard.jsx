  ...
  useEffect(() => {
    const getStats = async () => {
      try {
        ...
        const data = await axios.get(import.meta.env.VITE_REACT_APP_API_STATS_URL, {
    ...
    <Row gutter={8} style={{ justifyContent: 'center' }}>
      <Col span={12} style={{ minWidth: '100%' }}>
        <Card
          ...
          <Statistic
            title="Total Short URL Generated"
